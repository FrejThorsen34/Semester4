...
namespace MicrowaveOven.Test.Unit
{
    [TestFixture]
    public class UserInterfaceTest
    {
        ...
        public void SetTime_StartButton_CookerIsCalled()
        {
            ...
            cooker.Received(1).StartCooking(50 / 7, 60);
        }
        ...
        public void Ready_PowerAndTime_CookerIsCalledCorrectly()
        {
            ...
            cooker.Received(1).StartCooking(100 / 7, 120);
        }
        ...
        public void Ready_FullPower_CookerIsCalledCorrectly()
        {
            ...
            cooker.Received(1).StartCooking(700 / 7, 60);
        ...
        public void Cooking_CookingIsDone_ClearDisplay()
        {
            ...
            //Added CookingIsDone(), testing when cooking is done, not when it starts
            uut.CookingIsDone();
            display.Received(1).Clear();
        }
